...
public class AppiumConfig implements Task {
    String appPackage ="co.com.bancolombia.personas.superapp";
    //"co.com.bancolombia.personas.superapp";
    String appActivity = "co.com.bancolombia.personas.superapp.MainActivity";
    ...
    public <T extends Actor> void performAs(T actor) {
            ...
            try {
                UiAutomator2Options options = new UiAutomator2Options()
                        ...
                        .setDeviceName("Pixel_3a_API_36_extension_level_17_x86_64")
